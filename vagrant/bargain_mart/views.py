...
def ratelimit(limit, per=300, send_x_headers=True,
    ...
    def decorator(f):
        def rate_limited(*args, **kwargs):
            key = 'catalog/%s/%s' % (key_func(), scope_func())
    ...
    if items == []:
        item1 = Item(name="Pineapple",
                     ...
                     picture="https://upload.wikimedia.org/wikipedia/commons/"
                             "c/cb/Pineapple_and_cross_section.jpg",
                     description="Organically Grown in Hawai'i")
        session.add(item1)
        item2 = Item(name="Carrots",
                     price="$1.99",
                     picture="http://media.mercola.com/assets/images/"
                             "food-facts/carrot-fb.jpg",
        ...
        item4 = Item(name="Eggs",
                     price="$2.00",
                     picture="http://whatsyourdeal.com/grocery-coupons/"
                             "wp-content/uploads/2015/01/eggs.png",
                     description="Farm Fresh Organic Eggs")
        session.add(item4)
        item5 = Item(name="Bananas",
                     price="$2.15",
                     picture="http://dreamatico.com/data_images"
                             "/banana/banana-3.jpg",
